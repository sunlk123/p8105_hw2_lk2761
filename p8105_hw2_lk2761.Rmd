...
trash_wheel_data = 
  ...
  mutate(.data = ., 
         ...
         sports_ball_int = as.integer(sports_balls),
...
precip_combined = 
  ...
  select(.data = ., month, total_in, year, -total_inches)
```

The Mr. Trash Wheel dataset consists of `r nrow(trash_wheel_data)` observations.
